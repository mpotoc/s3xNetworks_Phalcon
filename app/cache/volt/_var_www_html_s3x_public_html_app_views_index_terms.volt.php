...
<div id="wrapper">
    <div id="selection">
        <div id="indexmain">
            ...
            <div id="indexcontent">
                <b style="color: #f24437 !important;">A) Responsability</b>
                <br />
                ...
                <br /><br />
                <b style="color: #f24437 !important;">B) Not employer</b>
                <br />
                ...
                <br /><br />
                <b style="color: #f24437 !important;">C) You are an adult</b>
                <br />
                You are an adult, being at least 18 years of age and you are not offended by adult content.
                <br /><br />
                <b style="color: #f24437 !important;">D) No offence</b>
                <br />
                ...
                the data is of purely private character and the content of this site in only for your own use.
                <br /><br />
                <b style="color: #f24437 !important;">E) No defamation</b>
                <br />
                ...
                <br /><br />
                <b style="color: #f24437 !important;">F) Use only original photos</b>
                <br />
                If we find you are using unauthorized photos in your ad, we will suspend your ad without refund.
                <br /><br />
                <b style="color: #f24437 !important;">G) No copy</b>
                <br />
                ...
                <br /><br />
                <b style="color: #f24437 !important;">H) Do not steal</b>
                <br />
                ...
                web site.
                <br /><br />
                <b style="color: #f24437 !important;">I) Do reciprocal</b>
                <br />
                ...
                <br /><br />
                <b style="color: #f24437 !important;">J) `Sex for money` and/or prostitution</b>
                <br />
                ...
                <br /><br />
                <b style="color: #f24437 !important;">K) Be informed</b>
                <br />
