...
<div id="container">
  <section id="menubar">
    <a href="<?= $this->url->getBaseUri() ?>"><img id="logo-main" src="../../img/<?= $mainLogo ?>.png" alt="Escort <?= $wcountry ?>"  title="<?= $mainTitle ?>" /></a>
    ...
    <a href="<?= $this->url->getBaseUri() ?>register">
...
<div id="footer">
  <div id="wrapperf">
    ...
    <a href="<?= $this->url->getBaseUri() ?>">www.<?= $mainLogo ?>.com</a> &copy; 2016<br /> All escorts were 18 or older at the time of depiction.
  </div>
