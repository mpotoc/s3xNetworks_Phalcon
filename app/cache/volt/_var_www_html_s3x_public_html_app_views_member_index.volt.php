        ...
        <div class="inside-forms">
            ...
            <!-- <div id="sgnup4" style="margin-bottom: 30px; padding-bottom: 0px !important;">
                ...
                <div class="profile1">
                    ...
                    <div class="profile3">
                        <a href="<?= $this->url->getBaseUri() ?>member/coins" class="myButton3">
            ...
            <div id="sgnup4" style="margin-bottom: 30px;">
                ...
                <div class="profile1">
                    ...
                    <a href="<?= $this->url->getBaseUri() ?>member/pm" class="myButton6">
                        <i class="icon-shopping-cart"></i> Private messages
                    </a>&nbsp;&nbsp;-->
                    <!--<a href="<?= $this->url->getBaseUri() ?>private/coins">
                        <div id="private2">
                    ...
                    <a href="<?= $this->url->getBaseUri() ?>member/settings" class="myButton6">
                        <i class="icon-key"></i> Settings
                    </a>&nbsp;&nbsp;
                    <a href="<?= $this->url->getBaseUri() ?>member/support" class="myButton6">
