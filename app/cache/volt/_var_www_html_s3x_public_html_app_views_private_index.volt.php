        ...
        <div class="inside-forms">
            ...
            <!--<div id="sgnup4" style="margin-bottom: 30px; padding-bottom: 0px !important;">
                ...
                <div id="coinstext1">
                    ...
                    our <a href="<?= $this->url->getBaseUri() ?>">www.<?= $mainLogo ?>.com</a> escort directory.
                </div>

                <div class="profile1">
                    <div class="profile2"><b>s3xcoins:</b> <?= $coins ?></div>
                    <div class="profile3">
                        <a href="<?= $this->url->getBaseUri() ?>private/coins" class="myButton3">
            ...
            <div id="sgnup4" style="margin-bottom: 30px;">
                ...
                <br />
                <div class="profile1">
                    <a href="<?= $this->url->getBaseUri() ?>private/addprofile" class="myButton6">
                        <i class="icon-folder-open"></i> Add Escort Profile
                    </a>&nbsp;&nbsp;
                    <a href="<?= $this->url->getBaseUri() ?>private/managemodels" class="myButton6">
                        <i class="icon-picture"></i> Manage Models
                    </a>&nbsp;&nbsp;
                    <a href="<?= $this->url->getBaseUri() ?>private/payment" class="myButton6">
                        <i class="icon-shopping-cart"></i> Buy Package
                    </a>&nbsp;&nbsp;
                    <a href="<?= $this->url->getBaseUri() ?>private/vip" class="myButton6">
                        <i class="icon-shopping-cart"></i> Buy VIP
                    </a>&nbsp;&nbsp;
                    <?php if ($mlm > 0) { ?>
                    <a href="<?= $this->url->getBaseUri() ?>private/bonus" class="myButton6">
                    ...
                    <!--<a href="<?= $this->url->getBaseUri() ?>private/tours">
                        <div id="private2">
                            <i class="icon-calendar privateb"></i><br>Tours
                        </div>
                    </a>
                    <a href="<?= $this->url->getBaseUri() ?>private/verification">
                        <div id="private2">
                            <i class="icon-camera-retro privateb"></i><br>100% Verified
                        </div>
                    </a>
                    <a href="<?= $this->url->getBaseUri() ?>private/pm" class="myButton6">
                        <i class="icon-key"></i> Private messages
                    </a>&nbsp;&nbsp;-->
                    <a href="<?= $this->url->getBaseUri() ?>private/settings" class="myButton6">
                        <i class="icon-key"></i> Settings
                    </a>&nbsp;&nbsp;
                    <a href="<?= $this->url->getBaseUri() ?>private/support" class="myButton6">
                        <i class="icon-headphones"></i> Support
                    </a>&nbsp;&nbsp;
                    <!--<a href="<?= $this->url->getBaseUri() ?>private/video">
                        <div id="private2">
                            <i class="icon-facetime-video privateb"></i><br>Video
                        </div>
                    </a>
                    <a href="<?= $this->url->getBaseUri() ?>private/pm">
                        <div id="private2">
                            <i class="icon-inbox privateb"></i><br>Private Messages
                        </div>
                    </a>
                    <a href="<?= $this->url->getBaseUri() ?>private/comments">
                        <div id="private2">
                            <i class="icon-comments privateb"></i><br>Reviews and Comments
                        </div>
                    </a>
                    <a href="<?= $this->url->getBaseUri() ?>private/boostprofile">
                        <div id="private2">
                            <i class="icon-plus-sign privateb"></i><br>Boost My Profile
                        </div>
                    </a>
                    <a href="<?= $this->url->getBaseUri() ?>private/blacklist">
                        <div id="private2">
                            <i class="icon-minus-sign privateb"></i><br>Blacklist
                        </div>
                    </a>
                    <a href="<?= $this->url->getBaseUri() ?>logout" class="myButton1">
                ...
                <div class="profile1">
                    ...
                    <div id="dropdown-1" class="dropdown dropdown-processed" style="margin-bottom: 5px;">
                        ...
                        <div class="dropdown-container" style="display: none;">
                            <p>
                                This is the package for top positions on <a href="<?= $this->url->getBaseUri() ?>">www.<?= $mainLogo ?>.com</a>. You
                                ...
                                listings on <a href="<?= $this->url->getBaseUri() ?>">www.<?= $mainLogo ?>.com</a>. The price for this package varies depending on
                    ...
                    <div id="dropdown-2" class="dropdown dropdown-processed" style="margin-bottom: 5px;">
                        ...
                        <div class="dropdown-container" style="display: none;">
                            <p>
                                This is the package after <b>Diamond</b> positions on <a href="<?= $this->url->getBaseUri() ?>">www.<?= $mainLogo ?>.com</a>.
                                ...
                                <b>Diamond</b> listings on <a href="<?= $this->url->getBaseUri() ?>">www.<?= $mainLogo ?>.com</a>. The price for this package
                    ...
                    <div id="dropdown-3" class="dropdown dropdown-processed" style="margin-bottom: 5px;">
                        ...
                        <div class="dropdown-container" style="display: none;">
                            <p>
                                This is the package after <b>Gold</b> positions on <a href="<?= $this->url->getBaseUri() ?>">www.<?= $mainLogo ?>.com</a>.
                                You can choose length for this package either 15 or 30 days. When less then 2 days of your current package are left, you
                                can extend this package for further 15 or 30 days, or change to different package. Your ad will be listed after
                                <b>Gold</b> listings on <a href="<?= $this->url->getBaseUri() ?>">www.<?= $mainLogo ?>.com</a>. The price for this package varies
                    ...
                    <div id="dropdown-4" class="dropdown dropdown-processed" style="margin-bottom: 5px;">
                        ...
                        <div class="dropdown-container" style="display: none;">
                            <p>
                                This is the package after <b>Silver</b> positions on <a href="<?= $this->url->getBaseUri() ?>">www.<?= $mainLogo ?>.com</a>.
                                ...
                                <b>Silver</b> listings on<a href="<?= $this->url->getBaseUri() ?>">www.<?= $mainLogo ?>.com</a>. The price for this package is FREE.
                            </p>
                        </div>
                    </div>
