    ...
    <div id="selectionadd">
        ...
        <div class="inside-forms">
            ...
            <div id="sgnup4" style="margin-bottom: 30px;">
                ...
                <?php $v161708215403971770501iterator = $t; $v161708215403971770501incr = 0; $v161708215403971770501loop = new stdClass(); $v161708215403971770501loop->self = &$v161708215403971770501loop; $v161708215403971770501loop->length = count($v161708215403971770501iterator); $v161708215403971770501loop->index = 1; $v161708215403971770501loop->index0 = 1; $v161708215403971770501loop->revindex = $v161708215403971770501loop->length; $v161708215403971770501loop->revindex0 = $v161708215403971770501loop->length - 1; ?><?php foreach ($v161708215403971770501iterator as $tour) { ?><?php $v161708215403971770501loop->first = ($v161708215403971770501incr == 0); $v161708215403971770501loop->index = $v161708215403971770501incr + 1; $v161708215403971770501loop->index0 = $v161708215403971770501incr; $v161708215403971770501loop->revindex = $v161708215403971770501loop->length - $v161708215403971770501incr; $v161708215403971770501loop->revindex0 = $v161708215403971770501loop->length - ($v161708215403971770501incr + 1); $v161708215403971770501loop->last = ($v161708215403971770501incr == ($v161708215403971770501loop->length - 1)); ?>
                <?php if ($v161708215403971770501loop->first) { ?>
                <div id="tours">
                ...
                <div id="tours">
                    ...
                    <div id="t3"><?= date('d/m/Y', strtotime($tour->datestart)) ?> <?= $tour->fromHour ?></div>
                    <div id="t3"><?= date('d/m/Y', strtotime($tour->dateend)) ?> <?= $tour->toHour ?></div>
                ...
                <?php $v161708215403971770501incr++; } ?>
            </div>
