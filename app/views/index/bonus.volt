    ...
    <div id="selection">
        <div id="indexmain">
            ...
            <div id="indexcontent">
                ...
                ad space on <a href="{{ url.getBaseUri() }}">www.{{ mainLogo }}.com</a>. <br /><br />

                <b style="color: #f24437 !important;">2. Bonuses in numbers</b>
                <br />
                When you want to buy packages <b>(diamond, gold, silver, vip)</b> on
                <a href="{{ url.getBaseUri() }}">www.{{ mainLogo }}.com</a> you must first buy s3xcoin package and
                ...
                <b>1 EUR = 1 s3xcoin on <a href="{{ url.getBaseUri() }}">www.{{ mainLogo }}.com</a>.</b><br/><br/>

                <b style="color: #f24437 !important;">3. Packages</b>
                <br />
                We offer 4 different main packages on <a href="{{ url.getBaseUri() }}">www.{{ mainLogo }}.com</a>: <br /><br/>
                <b>Diamond package</b> -> this is the package for top positions on <a href="{{ url.getBaseUri() }}">www.{{ mainLogo }}.com</a>. You
                ...
                on <a href="{{ url.getBaseUri() }}">www.{{ mainLogo }}.com</a>. The price for this package varies depending on the days you select. From
                ...
                <b>Gold package</b> -> this is the package after <b>Diamond</b> positions on <a href="{{ url.getBaseUri() }}">www.{{ mainLogo }}.com</a>.
                ...
                listings on <a href="{{ url.getBaseUri() }}">www.{{ mainLogo }}.com</a>. The price for this package varies depending on the days you
                ...
                <b>Silver package</b> -> this is the package after <b>Gold</b> positions on <a href="{{ url.getBaseUri() }}">www.{{ mainLogo }}.com</a>.
                ...
                <a href="{{ url.getBaseUri() }}">www.{{ mainLogo }}.com</a>. The price for this package varies depending on the days you
                ...
                <b>FREE package</b> -> this is the package after <b>Silver</b> positions on <a href="{{ url.getBaseUri() }}">www.{{ mainLogo }}.com</a>.
                ...
                as you want. Your ad will be listed after <b>Silver</b> listings on <a href="{{ url.getBaseUri() }}">www.{{ mainLogo }}.com</a>. The price
                ...
                <a href="{{ url.getBaseUri() }}">www.{{ mainLogo }}.com</a>: <br/><br/>
                <b>VIP</b> -> this package will put your listing to the top of the <a href="{{ url.getBaseUri() }}">www.{{ mainLogo }}.com</a>
                if your listing had <b>Diamond</b> package, otherwise it will put you to the top of the listings of your package on
                <a href="{{ url.getBaseUri() }}">www.{{ mainLogo }}.com</a>. <b>VIP</b> costs <b>5 s3xcoins (5 EUR)</b> per day.<br/><br/>

                <!--<b>Boosts</b> -> this package will boost your listing to the top of your paid package listings on
                <a href="{{ url.getBaseUri() }}">www.{{ mainLogo }}.com</a>, either 1x, 2x or 3x that day you buy it. Your listing will be on top
                ...
                for one time boost on <a href="{{ url.getBaseUri() }}">www.{{ mainLogo }}.com</a>.<br/><br/>

                <b>Girl of the day</b> -> this package will give your listing special status and it will be put on top of all listings on
                <a href="{{ url.getBaseUri() }}">www.{{ mainLogo }}.com</a>. This package is available only for <b>3 days</b> per purchase of this
                ...
                listing on <a href="{{ url.getBaseUri() }}">www.{{ mainLogo }}.com</a><br/><br/>-->
            </div>
            <br />
        </div>
    </div>
