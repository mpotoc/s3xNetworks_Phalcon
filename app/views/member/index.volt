    ...
    <div id="selection">
        ...
        <div class="inside-forms">
            ...
            <div id="sgnup4" style="margin-bottom: 30px;">
                This is the main member area of your account, here you can change your settings or write to support. Comments you can leave
                on each girl site. Every ad has option to comment it. This site will soon be updated with s3xcoins (buying, making gifts, paying
                for different things). Reviews will come shortly, so that you can judge the girls. Personal messages and many more still to come.
