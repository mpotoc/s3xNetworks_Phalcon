    ...
    <div id="selectionadd">
        ...
        <div class="inside-forms">
            ...
            <div id="sgnup4" style="margin-bottom: 30px;">
                ...
                '<b>Save</b>' button to update your profile.
            </div>
            ...
            <div id="sgnup4" style="margin-bottom: 30px;">
                ...
                <div class="profile1">
                    ...
                    <div class="profile4">
                        {{ form.render('slogan', ['class': 'form-control', 'placeholder': 'e.g., GFE', 'value': ads.slogan]) }}
                    </div>
                </div>
                ...
                <div class="profile1">
                    ...
                    <div class="profile4">
                        {% if ads.gender == 'F' %}
                        <label>Female: {{ form.render('gender', ['value': 'F', 'data-validetta': 'minChecked[1]', 'checked': true]) }}</label>
                        ...
                        <label>&nbsp;&nbsp;Male: {{ form.render('gender', ['value': 'M', 'data-validetta': 'minChecked[1]', 'checked': true]) }}</label>
                        <label>&nbsp;&nbsp;Transsexual: {{ form.render('gender', ['value': 'T', 'data-validetta': 'minChecked[1]']) }}</label>
                        {% elseif ads.gender == 'T' %}
                        <label>Female: {{ form.render('gender', ['value': 'F', 'data-validetta': 'minChecked[1]']) }}</label>
                        <label>&nbsp;&nbsp;Male: {{ form.render('gender', ['value': 'M', 'data-validetta': 'minChecked[1]']) }}</label>
                        <label>&nbsp;&nbsp;Transsexual: {{ form.render('gender', ['value': 'T', 'data-validetta': 'minChecked[1]', 'checked': true]) }}</label>
                        {% endif %}
                    </div>
                </div>
                ...
                <div class="profile1">
                    ...
                    <div class="profile4">
                        {{ form.render('age', ['class': 'form-control', 'placeholder': 'e.g., 20', 'data-validetta': 'required,positive,age', 'value': ads.age]) }}
                    </div>
                </div>
                ...
                <div class="profile1">
                    ...
                    <div class="profile4">
                        {{ form.render('ethnicity', ['class': 'form-control', 'data-validetta': 'required', 'value': ads.ethnicity]) }}
                    </div>
                </div>
                ...
                <div class="profile1">
                    ...
                    <div class="profile4">
                        {{ form.render('nationality', ['class': 'form-control', 'value': ads.nationality]) }}
                    </div>
                </div>
                ...
                <div class="profile1">
                    ...
                    <div class="profile4">
                        {{ form.render('home_country', ['class': 'form-control', 'value': ads.home_country]) }}
                    </div>
                </div>
                ...
                <div class="profile1">
                    ...
                    <div class="profile4">
                        {{ form.render('hairstyle', ['class': 'form-control', 'placeholder': 'e.g., long blonde', 'value': ads.hairstyle]) }}
                    </div>
                </div>
                ...
                <div class="profile1">
                    ...
                    <div class="profile4">
                        {{ form.render('eyes', ['class': 'form-control', 'placeholder': 'e.g., blue', 'value': ads.eyes]) }}
                    </div>
                </div>
                ...
                <div class="profile1">
                    ...
                    <div class="profile4">
                        {{ form.render('measurement', ['class': 'form-control', 'placeholder': 'e.g., 90-60-90', 'value': ads.measurement]) }}
                    </div>
                </div>
            </div>
            ...
            <div id="sgnup4" style="margin-bottom: 30px;">
                ...
                <div class="profile1">
                    ...
                    <div class="profile3">
                        {{ form.render('about_me', ['class': 'form-control', 'rows': '6', 'placeholder': 'e.g., Description about yourself (introduction)', 'data-validetta': 'required', 'value': ads.about_me]) }}
                    </div>
                </div>
                ...
                <div class="profile1">
                    ...
                    <div class="profile3">
                        {{ form.render('services', ['class': 'form-control', 'rows': '4', 'placeholder': 'e.g., Description about your services (GFE, 69, ...)', 'data-validetta': 'required', 'value': ads.services]) }}
                    </div>
                </div>
                ...
                <div class="profile1">
                    ...
                    <div class="profile3">
                        {{ form.render('languages', ['class': 'form-control', 'placeholder': 'e.g., English, Russian, French, Italian, ...', 'data-validetta': 'required', 'value': ads.languages]) }}
                    </div>
                </div>
                ...
                <div class="profile1">
                    ...
                    <div class="profile3">
                        {% if ads.orientation == 'B' %}
                            <label>Bisexual: {{ form.render('orientation', ['value': 'B', 'checked': true]) }}</label>
                        ...
                        {% elseif ads.orientation == 'S' %}
                            ...
                            <label>&nbsp;&nbsp;Heterosexual: {{ form.render('orientation', ['value': 'S', 'checked': true]) }}</label>
                            <label>&nbsp;&nbsp;Homosexual: {{ form.render('orientation', ['value': 'H']) }}</label>
                        {% elseif ads.orientation == 'H' %}
                            <label>Bisexual: {{ form.render('orientation', ['value': 'B']) }}</label>
                            <label>&nbsp;&nbsp;Heterosexual: {{ form.render('orientation', ['value': 'S']) }}</label>
                            <label>&nbsp;&nbsp;Homosexual: {{ form.render('orientation', ['value': 'H', 'checked': true]) }}</label>
                        {% else %}
                            <label>Bisexual: {{ form.render('orientation', ['value': 'B']) }}</label>
                            <label>&nbsp;&nbsp;Heterosexual: {{ form.render('orientation', ['value': 'S']) }}</label>
                            <label>&nbsp;&nbsp;Homosexual: {{ form.render('orientation', ['value': 'H']) }}</label>
            ...
            <div id="sgnup4" style="margin-bottom: 30px;">
                ...
                <div class="profile1">
                    ...
                    <div class="profile4">
                        {{ form.render('price1', ['class': 'form-control', 'data-validetta': 'required,positive', 'value': ads.price1]) }}
                    </div>
                </div>
                ...
                <div class="profile1">
                    ...
                    <div class="profile4">
                        {{ form.render('price2', ['class': 'form-control', 'data-validetta': 'required,positive', 'value': ads.price2]) }}
                    </div>
                </div>
                ...
                <div class="profile1">
                    ...
                    <div class="profile4">
                        {{ form.render('price3', ['class': 'form-control', 'data-validetta': 'price', 'value': ads.price3]) }}
                    </div>
                </div>
                ...
                <div class="profile1">
                    ...
                    <div class="profile4">
                        {{ form.render('price4', ['class': 'form-control', 'data-validetta': 'price', 'value': ads.price4]) }}
                    </div>
                </div>
            </div>
            ...
            <div id="sgnup4" style="margin-bottom: 30px;">
                ...
                <div class="profile1">
                    ...
                    <br/><br/>
                    ATTENTION: If you change "Working country:" you will have to either not save new changes or select back the cities you
                    had before when you edited your profile, if you want to keep "Working cities:" as it was before.
                </div>
                ...
                <div class="profile1">
                    ...
                    <div class="profile4">
                        {{ form.render('working_country', ['class': 'form-control', 'data-validetta': 'required', 'value': ads.working_country]) }}
                    </div>
                </div>
                ...
                <div class="profile1">
                    ...
                    <div class="profile4">
                        {{ form.render('working_time', ['class': 'form-control', 'placeholder': 'e.g., 24h, from 9 to 21', 'value': ads.working_time]) }}
                    </div>
                </div>
            ...
            <div id="sgnup4">
                ...
                <div class="profile1">
                    ...
                    <div class="profile4">
                        {{ form.render('phone', ['class': 'form-control', 'placeholder': 'format: +12345678999', 'data-validetta': 'required,phone', 'value': ads.phone]) }}
                    </div>
                </div>
                ...
                <div class="profile1">
                    ...
                    <div class="profile4">
                        {{ form.render('website', ['class': 'form-control', 'placeholder': 'e.g., http://www.mysite.com', 'value': ads.website]) }}
                    </div>
                </div>
                ...
                <div class="profile1">
                    ...
                    <div class="profile3">
                        {% if ads.contact_me == 'C' %}
                            <label>SMS and Call: {{ form.render('contact_me', ['value': 'C', 'data-validetta': 'minChecked[1]', 'checked': true]) }}</label>
                        ...
                        {% elseif ads.contact_me == 'S' %}
                            ...
                            <label>&nbsp;&nbsp;SMS Only: {{ form.render('contact_me', ['value': 'S', 'data-validetta': 'minChecked[1]', 'checked': true]) }}</label>
                        {% endif %}
                        {% if ads.no_witheld == 'Y' %}
                            <label>{{ form.label('no_witheld') }} {{ form.render('no_witheld', ['value': 'Y', 'checked': true]) }}</label>
                        {% else %}
                ...
                <div class="profile1">
                    ...
                    <div class="profile4">
                        {{ form.render('skype', ['class': 'form-control', 'placeholder': 'e.g., skype name', 'value': ads.skype]) }}
                    </div>
                </div>
                ...
                <div class="profile1">
                    ...
                    <div class="profile4">
                        {{ form.render('email', ['class': 'form-control', 'placeholder': 'e.g., e-mail', 'data-validetta': 'email', 'value': ads.email]) }}
                    </div>
                </div>
                ...
                <div class="profile1">
                    ...
                    <div class="profile3">
                        {% if ads.whatsapp == 'Y' %}
                        <label>{{ form.label('chekWhatsapp') }} {{ form.render('chekWhatsapp', ['value': 'Y', 'checked': true]) }}</label>
                        {% else %}
                        <label>{{ form.label('chekWhatsapp') }} {{ form.render('chekWhatsapp', ['value': 'Y']) }}</label>
                        {% endif %}
                        {% if ads.viber == 'Y' %}
                        <label>{{ form.label('chekViber') }} {{ form.render('chekViber', ['value': 'Y', 'checked': true]) }}</label>
                        {% else %}
                        <label>{{ form.label('chekViber') }} {{ form.render('chekViber', ['value': 'Y']) }}</label>
                        {% endif %}
                        {% if ads.line == 'Y' %}
                        <label>{{ form.label('chekLine') }} {{ form.render('chekLine', ['value': 'Y', 'checked': true]) }}</label>
                        {% else %}
                        <label>{{ form.label('chekLine') }} {{ form.render('chekLine', ['value': 'Y']) }}</label>
                        {% endif %}
                        {% if ads.wechat == 'Y' %}
                        <label>{{ form.label('chekWechat') }} {{ form.render('chekWechat', ['value': 'Y', 'checked': true]) }}</label>
                        {% else %}
