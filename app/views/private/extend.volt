    ...
    <div id="selectionadd">
        ...
        <div class="inside-forms">
            ...
            <div id="sgnup1">
                ...
                <div id="sgnupa">
                    <h2>Extend package</h2>
                </div>
            </div>

            <div id="sgnup4" style="margin-bottom: 30px;">
                All input fields marked with '<b>*</b>' are mandatory. You have to select a package you want to extend for this
                model. After that you have to select the '<b>Length</b>' of the selected package and click '<b>Extend package</b>' button.
            </div>
            ...
            <div id="sgnup4" style="margin-bottom: 30px;">
                ...
                <div class="profile1">
                    <b style="color: #003eff; font-size: 18px;">{{ currModel }}</b>
                    <input type="hidden" name="adverts" id="adverts" value="{{ ad_id }}">
                </div>
                ...
                <div class="profile1">
                    <div class="profilesubmit">{{ form.render('Extend package') }}</div>
                </div>
            </div>
            </form>
