...
$("#testbtn").click(function () {
    ...
    $('.thumb2').css('width', '125px');
    $('.thumb2').css('height', '182px');
...
$("#testbtn2").click(function () {
    ...
    $('.thumb2').css('width', '254px');
    $('.thumb2').css('height', '370px');
...
$(document).ready(function()
{
    ...
    $('.thumb2').hover(function()
    {
        ...
        //alert($arr[$n]);
        cycle2($this, $n);
        timer = setInterval(function(){ cycle2($this, $n); }, 650);
    }, function()
    {
        clearInterval(timer);
        //var $a = $n;
